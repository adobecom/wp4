...
<<<<<<< HEAD
`;var xr=class extends N{constructor(t){super(t)}getGlobalCSS(){return Vo}renderLayout(){return x`${this.cardImage}
=======
`;var br=class extends I{constructor(t){super(t)}getGlobalCSS(){return Mo}renderLayout(){return x`${this.cardImage}
>>>>>>> upstream/stage
    <div class="body">
...
<<<<<<< HEAD
`;var vr=class extends N{constructor(t){super(t)}getGlobalCSS(){return $o}renderLayout(){return x` ${this.badge}
=======
...
=======
    ${this.card.customHr?"":x`<hr />`} ${this.secureLabelFooter}`}};var Ho=`
>>>>>>> upstream/stage
  :root {
...
<<<<<<< HEAD
`;var tc=32,it=class extends N{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:x`<slot name="secure-transaction-label"></slot>`;return x`<footer>${r}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return Mo}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section"),["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let n=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");n&&n.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;[...this.card.querySelector('[slot="footer-rows"]')?.children].forEach((n,i)=>{let o=Math.max(tc,parseFloat(window.getComputedStyle(n).height)||0),a=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;o>a&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(n=>{let i=n.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&n.remove()})}renderLayout(){return x` <div class="top-section${this.badge?" badge":""}">
=======
...
<<<<<<< HEAD
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){mr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(it,"variantStyle",I`
=======
...
<<<<<<< HEAD
`;var ot=class extends N{constructor(t){super(t)}getGlobalCSS(){return Uo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
=======
`;var st=class extends I{constructor(t){super(t)}getGlobalCSS(){return Uo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
>>>>>>> upstream/stage
...
<<<<<<< HEAD
`;var Me=class extends N{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Do}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
=======
`;var Ue=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Do}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
>>>>>>> upstream/stage
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
<<<<<<< HEAD
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(mr()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Me,"variantStyle",I`
=======
...
<<<<<<< HEAD
`;var at=class extends N{constructor(t){super(t)}getGlobalCSS(){return Go}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
=======
`;var ct=class extends I{constructor(t){super(t)}getGlobalCSS(){return Bo}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
>>>>>>> upstream/stage
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
<<<<<<< HEAD
`;var rc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},st=class extends N{constructor(t){super(t)}getGlobalCSS(){return Ho}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return rc}renderLayout(){return x`${this.cardImage}
=======
...
<<<<<<< HEAD
`;var ct=class extends N{constructor(t){super(t)}getGlobalCSS(){return zo}renderLayout(){return x`${this.badge}
=======
`;var ht=class extends I{constructor(t){super(t)}getGlobalCSS(){return zo}renderLayout(){return x`${this.badge}
>>>>>>> upstream/stage
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var nc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"m"}},lt=class extends N{getGlobalCSS(){return Fo}get aemFragmentMapping(){return nc}renderLayout(){return x`
...
`;var oc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},dt=class extends I{getGlobalCSS(){return Fo}get aemFragmentMapping(){return oc}get stripStyle(){return this.card.backgroundImage?`
...
<<<<<<< HEAD
`;var ic={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},ht=class extends N{getGlobalCSS(){return jo}get aemFragmentMapping(){return ic}renderLayout(){return x` <div class="content">
=======
...
<<<<<<< HEAD
    `);var Hn=(e,t=!1)=>{switch(e.variant){case"catalog":return new nt(e);case"image":return new xr(e);case"inline-heading":return new vr(e);case"mini-compare-chart":return new it(e);case"plans":return new ot(e);case"product":return new Me(e);case"segment":return new at(e);case"special-offers":return new st(e);case"twp":return new ct(e);case"ccd-suggested":return new lt(e);case"ccd-slice":return new ht(e);default:return t?void 0:new Me(e)}},Ko=()=>{let e=[];return e.push(nt.variantStyle),e.push(it.variantStyle),e.push(Me.variantStyle),e.push(ot.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e};var Bo=document.createElement("style");Bo.innerHTML=`
=======
    `);var Bn=(e,t=!1)=>{switch(e.variant){case"catalog":return new ot(e);case"image":return new br(e);case"inline-heading":return new vr(e);case"mini-compare-chart":return new at(e);case"plans":return new st(e);case"product":return new Ue(e);case"segment":return new ct(e);case"special-offers":return new lt(e);case"twp":return new ht(e);case"ccd-suggested":return new dt(e);case"ccd-slice":return new ut(e);default:return t?void 0:new Ue(e)}},jo=()=>{let e=[];return e.push(ot.variantStyle),e.push(at.variantStyle),e.push(Ue.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e.push(ut.variantStyle),e};var Yo=document.createElement("style");Yo.innerHTML=`
>>>>>>> upstream/stage
:root {
...
<<<<<<< HEAD
`;document.head.appendChild(Bo);var oc="#000000",ac="#F8D904",sc=/(accent|primary|secondary)(-(outline|link))?/,cc="mas:product_code/",lc="daa-ll",br="daa-lh";function hc(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=le("merch-icon",s);t.append(c)})}function dc(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||oc),t.setAttribute("badge-background-color",e.badgeBackgroundColor||ac))}function uc(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function mc(e,t,r){e.cardTitle&&r&&t.append(le(r.tag,{slot:r.slot},e.cardTitle))}function pc(e,t,r){e.subtitle&&r&&t.append(le(r.tag,{slot:r.slot},e.subtitle))}function fc(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(le(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function gc(e,t,r){if(e.prices&&r){let n=le(r.tag,{slot:r.slot},e.prices);t.append(n)}}function xc(e,t,r){if(e.description&&r){let n=le(r.tag,{slot:r.slot},e.description);t.append(n)}}function vc(e,t,r,n){n==="ccd-suggested"&&!e.className&&(e.className="primary-link");let i=sc.exec(e.className)?.[0]??"accent",o=i.includes("accent"),a=i.includes("primary"),s=i.includes("secondary"),c=i.includes("-outline");if(i.includes("-link"))return e;let l="fill",d;o||t?d="accent":a?d="primary":s&&(d="secondary"),c&&(l="outline"),e.tabIndex=-1;let u=le("sp-button",{treatment:l,variant:d,tabIndex:0,size:r.ctas.size??"m"},e);return u.addEventListener("click",m=>{m.target!==e&&(m.stopPropagation(),e.click())}),u}function bc(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function Ac(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=le("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";return t.consonant?bc(s,c):vc(s,c,r,n)});o.innerHTML="",o.append(...a),t.append(o)}}function Ec(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(cc))?.split("/").pop();n&&(t.setAttribute(br,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(lc,`${i.dataset.analyticsId}-${o+1}`)}))}async function Yo(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.removeAttribute(br),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(fc(r,t,i.backgroundImage,n),dc(r,t),Ac(r,t,i,n),xc(r,t,i.description),hc(r,t,i.mnemonics),gc(r,t,i.prices),uc(r,t,i.allowedSizes),pc(r,t,i.subtitle),mc(r,t,i.title),Ec(r,t))}var Sc="merch-card",yc=1e4,Fn,Rt,zn,Ot=class extends ee{constructor(){super();M(this,Rt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");M(this,Fn,!1);this.filters={},this.types="",this.selected=!1,this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Hn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Hn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(fr,this.handleQuantitySelection),this.addEventListener(Tn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Ve,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(fr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(pr,this.handleStorageChange),this.removeEventListener(Ve,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Ve&&fe(this,Rt,zn).call(this,"AEM fragment cannot be loaded"),r.type===Re&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await Yo(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),yc));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(wn,{bubbles:!0,composed:!0}));return}fe(this,Rt,zn).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Ln,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(pr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Fn=new WeakMap,Rt=new WeakSet,zn=function(r){this.dispatchEvent(new CustomEvent(Pn,{detail:r,bubbles:!0,composed:!0}))},p(Ot,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:br,reflect:!0}}),p(Ot,"styles",[No,Ko(),...ko()]);customElements.define(Sc,Ot);var dt=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
